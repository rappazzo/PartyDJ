...
public final class Debug {
   ...
   private static PrintStream out = new PrintStream(new OutputStream() {
      ...
      @Override public void write(byte b[], int start, int off) throws IOException {}
   });
   ...
   public static String getDebug(String message, byte v[], int max) {
      ...
      if (v == null)
         ...
         if (v.length > max) result.append("\t" + "..." + newline);
   ...
   public static String getDebug(String message, char v[]) {
      ...
      if (v == null)
         ...
         for (int i = 0; i < v.length; i++)
            result.append(getDebug("\t" + v[i] + " (" + (0xff & v[i])) + ")" + newline);
         result.append(newline);
      }
      return result.toString();
   }
   ...
   public static String getDebug(String message, Map map) {
      ...
      if (map == null) return getDebug(message + " map: " + null);
      ...
      for (int i = 0; i < keys.size(); i++) {
         ...
         result.append(getDebug("\t" + i + ": '" + key + "' -> '" + value + "'") + newline);
      }
   ...
   private static void log(StringBuffer buffer, String s) {
      Debug.debug(s);
      if (buffer != null) buffer.append(s + newline);
   }
   ...
   public static boolean compare(String prefix, Map a, Map b, ArrayList ignore, StringBuffer buffer) {
      ...
      if (result) log(buffer, prefix + "a is the same as  b");
   ...
   public static String getDebug(String message, File file) {
      return getDebug(message + ": " + ((file == null) ? "null" : file.getPath()));
   }
   ...
   public static String getDebug(String message, Object value[]) {
      ...
      if (value == null) result.append(getDebug(message, "null") + newline);

      result.append(getDebug(message, value.length));
      final int max = 10;
      for (int i = 0; i < value.length && i < max; i++)
         result.append(getDebug("\t" + i, value[i]) + newline);
      if (value.length > max) result.append(getDebug("\t...") + newline);
      result.append(newline);
   ...
   public static String getStackTrace(Throwable e, int limit, int skip) {
      ...
      if (e != null) {
         ...
         if (stes != null) {
            ...
            if (limit >= 0 && stes.length > limit) result.append("\t..." + newline);
         }
   ...
   public static void debugByteQuad(String message, int i) {
      ...
      out.println(message + ": " + "alpha: " + alpha + ", " + "red: " + red + ", " + "green: " + green + ", " + "blue: " + blue);
   }
   ...
   public static void debugIPQuad(String message, int i) {
      ...
      out.println(message + ": " + "b1: " + b1 + ", " + "b2: " + b2 + ", " + "b3: " + b3 + ", " + "b4: " + b4);
   }
